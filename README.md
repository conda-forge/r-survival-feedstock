...
pixi global install r-survival
```
...
It is possible to list all of the versions of `r-survival` available on your platform:
...
```
pixi search r-survival --channel conda-forge
```
